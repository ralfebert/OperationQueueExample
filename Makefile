...
assets:
	# export icon
	sketchtool export slices OperationQueueExample/Assets/AppIcon.sketch && mv Icon.png icon*.png OperationQueueExample/Assets/Assets.xcassets/AppIcon.appiconset/
	...
	sketch-xcassets OperationQueueExample/Assets/Assets.sketch OperationQueueExample/Assets/Assets.xcassets
